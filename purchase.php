...
?>
        ...
        <div class="title-page">
                <h1>Wao you have choosen <?php echo mysqli_num_rows($result); ?> clases from us</h1>
        </div>
        <form method="POST" action=""> 
                ...
                <table class="table">
                    ...
                    <th>SubjectName</th>
                        ...
                        <th>Fee</th>
                        <th>Level</th>
                        <th><button type="submit" name="remove">Remove</button><input type="checkbox" id="delete_all" />Delete all</th>
                        <th><button type="submit" name="buy">Cal</button> <input type="checkbox" id="select_all" />Select all</th>
                    </thead>
...
?>
                ...
                <h1 for="total"><?php echo $total_money;?> $</h1><br>
<?php
            }
            ...
            if(isset($_POST['payment'])){
                if(isset($_POST['buyID'])){
                    foreach($_POST['buyID'] as $classID){
                        ...
                        // ob_flush();
                        header('Location: purchase.php?id2='.urlencode($params['id2'])."&role=".urldecode($params['role']));
                }
            }
            }
?>
